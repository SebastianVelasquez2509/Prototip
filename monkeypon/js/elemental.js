...
function crearMensaje(resultado)
{
    ...
    let ataquesDelPlayer=document.getElementById("AtaquePlayer")
    let ataquesDelPC=document.getElementById("AtaquePC")
    ...
    nuevoAtaquePlayer.innerHTML = nuevoAtaquePlayer
    nuevoAtaquePC.innerHTML = nuevoAtaquePC

    sectionMensajes.appendChild(notificacion)
    ataquesDelPlayer.appendChild(nuevoAtaquePlayer)
